          ...
          children: [
            ...
            Expanded(
              child: Column(
                  ...
                  children: [
                    Text(
                      quiz.quizTitle.isEmpty ? "Spørgsmål" : quiz.quizTitle,
                      style: TextStyle(fontSize: 24),
                    ),
                    Text("Point: ${quiz.score}",
                        style: TextStyle(
                            color: ThemeHelper.accentColor, fontSize: 18)),
                    Text("Forbrugt tid: ${quiz.timeTaken}"),
                    Text(
                        "Tidspunkt: ${quiz.quizDate.year}-${quiz.quizDate.month}-${quiz.quizDate.day} ${quiz.quizDate.hour}:${quiz.quizDate.minute}"),
                  ]),
            ),
            Column(
              children: [
